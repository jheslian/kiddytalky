# Generated by Django 3.1.7 on 2021-04-14 14:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_video', models.CharField(blank=True, default='', max_length=500, null=True)),
                ...
                ('correspondent_language', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='correspondent_language', to='main.language')),
